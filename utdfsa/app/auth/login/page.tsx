  ...
  return (
    <div className="min-h-screen bg-[#051005] flex items-center justify-center">
      <div className="w-full max-w-sm flex flex-col gap-4">
        <h1 className="text-white text-2xl font-bold tracking-tight text-center mb-2">Log in</h1>
        <input
          type="email"
          placeholder="Email"
          value={email}
        ...
        <button
          ...
          className="w-full px-6 py-2.5 rounded-full bg-white/5 hover:bg-white/10 active:scale-95 border border-white/10 text-white/80 text-sm font-medium tracking-wide transition-all duration-150 flex items-center justify-center gap-2"
        >
