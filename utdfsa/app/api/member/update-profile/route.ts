...
//
// data:  members
// notes: only updates name/phone/year/major/shirt_size/contact_email; does not affect
...
export async function POST(req: Request) {
  ...
  const { first_name, last_name, phone, year, major, shirt_size, contact_email } = parsed.data
