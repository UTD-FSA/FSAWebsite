// ── error.tsx (member) ────────────────────────────────────
// member-area segment error boundary — shown when a /member/* page throws
//
...
export default function MemberError({
  ...
  useEffect(() => {
    console.error('[member error boundary]', error)
  }, [error])
    ...
    <main className="bg-brand-bg min-h-screen flex items-center justify-center text-white px-6">
      <div className="text-center max-w-sm">
        ...
        <p className="font-sans text-white/50 text-sm mb-6">
          This page couldn&apos;t load. Try refreshing, or go back to your profile.
        </p>
